...
<?php   include("../Entete.php");
 ...
 <form name="comm" method="POST" action="">
							  ...
							  <tr><td colspan = 3><font size=3pt><?php echo ($a['titre'] ); ?><font></td></tr>
                               ...
                               <tr><td colspan = 3><textarea method="POST" name="comm" placeholder=""rows=5 cols=100 readonly="try"><?php echo ($a['Memo'] );?></textarea></td></tr>
							    <?php 
...
if (!isset($_GET['debut'])) $_GET['debut'] = 0;$nb_affichage_par_page = 4;
		  ...
		  $req=mysql_query($rs);
		  if($req){?><a href=""><script type='text/javascript'>alert("votre commentaire a été enregisté")</script>")</a>
