                                                ...
                                                <div class="subelement ">
                                                   <!-- <a href="">
                                                         <img src="ORABANK%20EPaiement_fichiers/xml-attente.png" alt="">
                                                          <h3 align="left"><b> Liste de toute les utilisateurs:</b></h3>
                                                     </a>-->
                                                </div>
        ...
        <div class="kendo"> 
            ...
            <table class="listeBfuAttente infoCompte noLeftBorder noGras">
               ...
               <?php 
                         ...
                         $req="SELECT * FROM `employe` limit ".$_GET['debut'].", ".$nb_affichage_par_page."";
					     $rs=mysql_query($req);
						 if($rs){
						 ...
						 while($a=mysql_fetch_assoc($rs)){
							...
							print " </tr>";
						        ...
						        ?> 
								<tr><td colspan =6><?php 	
						 echo barre_navigation($nb_total, $nb_affichage_par_page, $_GET['debut'], 3); } mysql_free_result($resultat);?></td></tr>
