...
<?php
 ...
 <form name="comm" method="POST" action="">
							  ...
							  <tr><td colspan = 3><font size=3pt><?php echo ($a['titre'] ); ?></font></td></tr>
                               <tr><td colspan = 3><textarea method="POST" name="comm" rows=1 cols=100 readonly="try"><?php echo ($a['Memo']);?></textarea></td></tr>
							  <?php 
...
if (!isset($_GET['debut'])) $_GET['debut'] = 0;$nb_affichage_par_page = 4;
		  ...
		  $req=mysql_query($rs);
		  if($req){
		  header("location:affich_ajout_comm_client.php?Id_Rapport='".$idrapp."'");
